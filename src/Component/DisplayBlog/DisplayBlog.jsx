        ...
        <div className=" w-full">
          ...
          <div className=" flex items-center justify-between">
            <div className=" flex items-center ">
              <p className=" border-r-4 border-[#8f8e8e] pr-3 text-xl font-bold font-PlayFair text-[#3f3c3c]">
                {author}
              </p>
              <p className="text-xl font-bold font-sans pl-3 text-[#3f3c3c]">
                {published_date}
              </p>
            </div>
          ...
          <div className="pt-14 pb-7 text-right">
            <NavLink to={`/blogDetails/${id}`}>
              <button className="hover:bg-gradient-to-r bg-white from-[#ff0000] to-[#FF8938] px-12 py-3 rounded-lg font-bold hover:text-white font-PlayFair text-xl border border-[#FF8938] ml-7 duration-700 hover:duration-700 hover:delay-300  ">
                Read More
              </button>
            </NavLink>
          </div>
